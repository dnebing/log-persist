 ...
 */
@ProviderType
public interface LoggingConfigPersistence extends BasePersistence<LoggingConfig> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public LoggingConfig findByLogger(java.lang.String logger)
	...
	*/
	public LoggingConfig fetchByLogger(java.lang.String logger);
	...
	*/
	public LoggingConfig removeByLogger(java.lang.String logger)
		throws NoSuchLoggingConfigException;
	...
	*/
	public int countByLogger(java.lang.String logger);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, LoggingConfig> fetchByPrimaryKeys(
	...
	*/
	public java.util.List<LoggingConfig> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<LoggingConfig> orderByComparator);
