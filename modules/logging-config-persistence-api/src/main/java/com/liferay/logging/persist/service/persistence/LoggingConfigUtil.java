...
public class LoggingConfigUtil {
	...
	private static ServiceTracker
		<LoggingConfigPersistence, LoggingConfigPersistence> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(LoggingConfigPersistence.class);

		ServiceTracker<LoggingConfigPersistence, LoggingConfigPersistence>
			serviceTracker =
				new ServiceTracker
					<LoggingConfigPersistence, LoggingConfigPersistence>(
						bundle.getBundleContext(),
						LoggingConfigPersistence.class, null);
